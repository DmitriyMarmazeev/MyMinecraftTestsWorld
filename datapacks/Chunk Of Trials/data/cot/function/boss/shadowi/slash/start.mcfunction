...
execute at @e[tag=boss,type=minecraft:armor_stand,limit=1] run tag @p[tag=!damaged,gamemode=adventure] add target
...
rotate @e[tag=freeze,limit=1] facing entity @e[tag=boss,type=minecraft:armor_stand,limit=1]
